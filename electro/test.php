...
<tr><td align="center"><?php echo $count; ?></td><td align="center"><?php echo $row["fullname"]; ?></td><td align="center"><?php echo $row["address"]; ?></td><td align="center"><a href="edit.php?id=<?php echo $row["username"]; ?>">Edit</a></td><td align="center"><a href="delete.php?id=<?php echo $row["mobilenumber"]; ?>">Delete</a></td></tr>
<?php $count++; } ?>
</tbody>
</table>
